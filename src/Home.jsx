...
export const Home = () => {
    ...
    return (
        <div className='homeContentContainer'>
            <div className="relative isolate px-6 pt-14 lg:px-8 main-div container1 homeSection1 homeSections">
                ...
                <div className="mx-auto max-w-4xl py-32 sm:py-48 lg:py-46">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-slate-600 main-para">
                ...
                <div className="feat bg-gray pt-5 pb-5">
                    <div className="container">
                        <div className="row">
                            ...
                            <HomeCard icon="./Icons/ic_expertise.svg" title="Innovation" desc="We prioritize innovation, consistently exploring new technologies and strategies to optimize your IT infrastructure."/>
                            <HomeCard icon="./Icons/ic_security.svg" title="Tailored Service" desc="We customize our services to match your unique business challenges, goals, and objectives, ensuring you receive precisely what you need."/>
                            <HomeCard icon="./Icons/ic_security.svg" title="Customer-Centric" desc="Your success is our top priority, and we work closely with you, communicating transparently and proactively."/>
            ...
            <div className='container-fluid homeSections forHomeSection'>
                <div className="feat bg-gray pt-5 pb-5">
            ...
            <div className='container-fluid homeSections'>
